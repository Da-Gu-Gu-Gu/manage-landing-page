...
const Landing = () => {
  return (
    ...
    <div className='w-full  lg:order-1 order-2 lg:w-1/2 xl:w-[45%] h-1/2 lg:h-full flex justify-center lg:justify-end  items-center '>
        ...
        <h1 className='text-db landtext text-3xl md:text-5xl xl:text-6xl font-normal'>Bring everyone <br/>
...
better products.
    ...
    <div className='w-full order-1  lg:order-2 relative lg:w-1/2 xl:w-[55%] h-1/2 lg:h-full flex items-end md:items-center justify-center '>
        <div className="landbg absolute  -top-56   right-0 md:-top-20  lg:-top-40 lg:-right-72 h-full"> </div>
        <img src={mockup} alt="" className='intro-img  absolute  z-10'/>
    </div>
</div>
  )
}
